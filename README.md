...
**Adriano Polzer, Jannik Rombach** — RL Course 2025/26 at the University of Tübingen.
...
under different training conditions. The core finding: training against a **diverse, dynamically growing opponent pool via self-play** is the primary driver of agent robustness — fixed-opponent training consistently led to less stable strategies.
...
- **Adriano Polzer** — SAC implementation
- **Jannik Rombach** — TD3 implementation
- Shared: training infrastructure, evaluation, experimentation
